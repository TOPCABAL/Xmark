...
#### 主要访问地址
- **前端应用**: `http://45.77.244.29:5173`
- **后端API**: `http://45.77.244.29:3001`
- **数据库管理**: `http://45.77.244.29:5173/public/dbmanager.html`

> 注意：在实际部署时，请将IP地址 `45.77.244.29` 替换为您的VPS IP地址。

#### 功能入口
- 主界面用于管理和标注Twitter关注列表
- 数据库管理页面提供数据库操作和维护功能
- API端点支持数据的增删改查操作

#### 访问说明
1. 确保VPS服务正常运行
2. 使用现代浏览器（Chrome、Firefox、Safari等）访问
3. 如遇访问问题，请检查VPS防火墙设置（端口3001和5173）